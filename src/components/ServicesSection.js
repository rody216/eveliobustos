...
const services = [
  {
    ...
    description: "Optimización de impuestos y cumplimiento de obligaciones fiscales tanto para personas naturales como jurídicas, garantizando la máxima eficiencia y legalidad.",
    icon: (
