      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:space-x-12">
          ...
          <div className="lg:w-1/2 text-gray-300">
            ...
            <p className="text-lg leading-relasxed mb-6">
            ...
            <p className="text-lg leading-relaxed mb-6">
              Mi misión es ofrecer un servicio personalizado, eficiente y estratégico, generando tranquilidad y confianza en cada proceso contable. Me respaldo en una sólida formación académica y una trayectoria que incluye el sector público, privado y militar.
            </p>
