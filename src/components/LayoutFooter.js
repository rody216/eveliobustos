      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Logo y lema */}
          <div className="text-center md:text-left">
            ...
            <p className="text-lg font-bold mb-2 text-[#FFD700] transition-transform duration-300 hover:scale-105">
              Evelio Bustos Apache
            </p>
            
            <p className="text-sm text-gray-300 transition-transform duration-300 hover:scale-105">
              Contador Público - Revisor Fiscal
            </p>
            
            <p className="text-lg text-[#FFD700] mt-3 transition-transform duration-300 hover:scale-105">
      ...
      {/* Navegación */}
            ...
            {[
              ...
              <li key={target}>
                <button
                  ...
                  className="text-white hover:text-[#FFD700] transition-all duration-300 transform hover:scale-105"
                >
                  {label}
                </button>
              </li>
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start space-x-4 mt-6">
            ...
            {/* Facebook */}            
            <a
              href="https://www.facebook.com/bustosapache"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/evelio-bustos-apache-270878373/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* X */}
            <a
              href="https://x.com/eveliobustosapache"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#FFD700] hover:text-black transition-colors transform hover:scale-125"
            ...
            {/* Instagram */}
            <a
              href="https://instagram.com/eveliobustosapache"
              target="_blank"
              rel="noopener noreferrer"
