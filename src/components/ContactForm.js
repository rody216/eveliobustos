...
const ContactForm = () => {
  ...
  <div className="flex space-x-4">
   ...
   {/* WhatsApp */}
<a
  href="https://wa.me/573103704356?text=¡Hola!%20Gracias%20por%20contactarte%20con%20Evelio%20Bustos%20Apache.%20¿En%20qué%20puedo%20ayudarte%20hoy?" target="_blank" rel="noopener noreferrer"
  aria-label="WhatsApp"
  className="text-[#FFD700] hover:text-[#25D366] hover:scale-110 transition-all"
>
